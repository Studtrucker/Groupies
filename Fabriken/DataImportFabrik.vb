...
Public Class SpaltennamenTeilnehmer
    ...
    Sub New()
        _Spalten = New List(Of String) From {"Ident", "Vorname", "Nachname", "Geburtsdatum", "Telefonnummer", "Leistungsstufe"}
    End Sub
...
Public Class SpaltennamenTrainer
    ...
    Sub New()
        _Spalten = New List(Of String) From {"Ident", "Vorname", "Nachname", "Alias", "Telefonnummer", "E-Mail"}
    End Sub
