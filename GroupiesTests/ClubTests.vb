...
Public Class ClubTests
    ...
    Public Sub TestTeilnehmerEingruppierenUndEntfernen()
        ...
        Stubai2024.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe.Add(Studti)
        Stubai2024.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe.Add(Manuela)
        Stubai2024.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe.Add(Lina)

        Assert.AreEqual(3, Stubai2024.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe.Count)
        ...
        Stubai2024.Einteilungsliste(0).Gruppenliste = AppController.AktuellerClub.Gruppenliste

        Stubai2024.Einteilungsliste(0).TeilnehmerInGruppeEinteilen(Studti, Stubai2024.Einteilungsliste(0).Gruppenliste.ElementAt(0))
        'Assert.AreEqual(3, Stubai2024.Einteilungsliste(0).EinteilungAlleTeilnehmer.Count)
        Assert.AreEqual(2, Stubai2024.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe.Count)
        ...
        'Assert.AreEqual(3, Stubai2024.Einteilungsliste(0).EinteilungAlleTeilnehmer.Count)
        Assert.AreEqual(1, Stubai2024.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe.Count)
    ...
    Public Sub TestTrainerEingruppierenUndEntfernen()
        ...
        Assert.AreEqual(3, Stubai2024.Einteilungsliste(0).VerfuegbareTrainerListe.Count)
        ...
        Assert.AreEqual(2, Stubai2024.Einteilungsliste(0).VerfuegbareTrainerListe.Count)
        ...
        Assert.AreEqual(1, Stubai2024.Einteilungsliste(0).VerfuegbareTrainerListe.Count)
        ...
        Assert.AreEqual("Manuela Ramm", Stubai2024.Einteilungsliste(0).VerfuegbareTrainerListe.ElementAt(0).VorUndNachname)
    ...
    Public Sub TestEingeteilteTeilnehmer()
        ...
        Testverein.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe = New TeilnehmerCollection(New List(Of Teilnehmer) From {Studti, Manu, Ralf, Sandra, Rene})
        ...
        ' Test
        Assert.AreEqual(3, Testverein.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe.Count)
