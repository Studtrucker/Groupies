...
Public Class LeistungsstufeTests
    ...
    Public Sub TestKonstruktor()
        ...
        Dim l2 = New Entities.Leistungsstufe("Anfänger") With {.Sortierung = "003"}
        Assert.AreEqual("Anfänger", l2.ToString)
        Assert.AreEqual(3, l2.Sortierung)

        Dim l3 = New Entities.Leistungsstufe("Experte") With {.Beschreibung = "Fährt sicher auf Schwarzen Pisten und im Gelände"}
