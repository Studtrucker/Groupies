...
Public Class SkiDateienServiceTests
    ...
    Public Sub LadenDateiGeneration1_In_AktuelleStruktur()
        ...
        Assert.AreEqual(2, Club.Einteilungsliste(0).VerfuegbareTrainerListe.Count)
    End Sub
    ...
    Public Sub LadenDateiGeneration2_In_AktuelleStruktur()
        ...
        Assert.AreEqual(1, Club.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe.Count)
        'Assert.AreEqual(56, Club.Einteilungsliste(0).EinteilungAlleTeilnehmer.Count)
        Assert.AreEqual(1, Club.Einteilungsliste(0).VerfuegbareTrainerListe.Count)
    ...
    Public Sub LadenDateiGeneration3_In_AktuelleStruktur()
        ...
        Assert.AreEqual(9, Club.Einteilungsliste(0).Gruppenliste.Count)
        'Assert.AreEqual(55, Club.Einteilungsliste(0).EingeteilteTeilnehmer.Count)
        Assert.AreEqual(0, Club.Einteilungsliste(0).NichtZugewieseneTeilnehmerListe.Count)
