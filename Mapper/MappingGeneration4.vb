...
Public Module MappingGeneration4
    ...
    Private Function GetAlleGruppen(Skiclub As Generation4.Club) As GruppeCollection
        ...
        Skiclub.AlleEinteilungen.ToList.ForEach(Sub(E) E.Gruppenliste.ToList.ForEach(Sub(g) Gruppen.Add(g)))
    ...
    Private Function GetAlleFaehigkeiten(Skiclub As Generation4.Club) As FaehigkeitCollection
        ...
        Skiclub.AlleEinteilungen.ToList.ForEach(Sub(E) E.Gruppenliste.ToList.ForEach(Sub(g) g.Mitgliederliste.ToList.ForEach(Sub(M) M.Leistungsstand.Faehigkeiten.ToList.ForEach(Sub(f) Faehigkeiten.Add(f)))))
    ...
    Private Function GetAlleTeilnehmer(Skiclub As Generation4.Club) As TeilnehmerCollection
        ...
        Skiclub.AlleEinteilungen.ToList.ForEach(Sub(E) E.Gruppenliste.ToList.ForEach(Sub(g) g.Mitgliederliste.ToList.ForEach(Sub(T) Teilnehmer.Add(T))))
    ...
    Private Function GetAlleTrainer(Skiclub As Generation4.Club) As TrainerCollection
        ...
        Skiclub.AlleEinteilungen.ToList.ForEach(Sub(E) E.Gruppenliste.ToList.ForEach(Sub(g) Trainer.Add(g.Trainer)))
    ...
    Private Function GetAlleLeistungsstufenVonGruppen(Skiclub As Generation4.Club) As LeistungsstufeCollection
        ...
        Skiclub.AlleEinteilungen.ToList.ForEach(Sub(E) E.Gruppenliste.ToList.ForEach(Sub(g) Leistungsstufen.Add(g.Leistungsstufe)))
    ...
    Private Function GetAlleLeistungsstufenVonTeilnehmern(Skiclub As Generation4.Club) As LeistungsstufeCollection
        ...
        Skiclub.AlleEinteilungen.ToList.ForEach(Sub(E) E.Gruppenliste.ToList.ForEach(Sub(Gl) Gl.Mitgliederliste.ToList.ForEach(Sub(M) Leistungsstufen.Add(M.Leistungsstand))))
