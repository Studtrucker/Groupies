...
#Region "Funktionen und Methoden"
        ...
        Public Sub ImportTrainer()
            ...
            Dim TraineranzahlVorImport = AppController.AktuellerClub.SelectedEinteilung.AlleTrainer.Count
            ...
            If AppController.AktuellerClub.SelectedEinteilung.AlleTrainer Is Nothing Then
        ...
        Public Sub ImportTeilnehmer()
            ...
            Dim TeilnehmerzahlVorImport = AppController.AktuellerClub.SelectedEinteilung.AlleTeilnehmer.Count
            ...
            If AppController.AktuellerClub.SelectedEinteilung.AlleTeilnehmer Is Nothing Then
            ...
            For Each aktuellerTn As Teilnehmer In AppController.AktuellerClub.SelectedEinteilung.AlleTeilnehmer
            ...
            AppController.AktuellerClub.SelectedEinteilung.AlleTeilnehmer.ToList.ForEach(Sub(Tn) Tn.Archivieren = True)
            ' Alle Archivkandidaten werden, wenn sie in der Importdatei gelistet sind, beibehalten
            For Each importTn In ImportTeilnehmerliste
                AppController.AktuellerClub.SelectedEinteilung.AlleTeilnehmer.ToList.Where(Function(Tn) _
            ...
            Dim BekannteTeilnehmer = ImportTeilnehmerliste.Where(Function(Tn) Tn.IstBekannt).
                Select(Function(Tn) AppController.AktuellerClub.SelectedEinteilung.AlleTeilnehmer.
            ...
            For Each BTn As DataImport.Teilnehmer In BekannteTeilnehmerliste
                Dim Tn = AppController.AktuellerClub.SelectedEinteilung.AlleTeilnehmer.Where(Function(ATn) ATn.TeilnehmerID = BTn.TeilnehmerID).Select(Function(Atn) Atn)
                If Tn.Count = 1 Then
            ...
            ' Alle zu archivierenden Teilnehmer 
            Dim ZuArchivierende = AppController.AktuellerClub.SelectedEinteilung.AlleTeilnehmer.ToList.Where(Function(Tn) Tn.Archivieren = True)

            ' Teilnehmer in der ewigen Liste archivieren
            Dim Archiv = AppController.AktuellerClub.SelectedEinteilung.AlleTeilnehmer.ToList.Where(Function(Tn) Tn.Archivieren = True).Select((Function(Tn) New EwigerTeilnehmer(Tn, Now.Date)))
            ' Teilnehmer, die nicht dabei sind, aussortieren
            For Each ArchivTn In ZuArchivierende
                ...
                AppController.AktuellerClub.SelectedEinteilung.Gruppenliste.ToList.ForEach(Sub(Gr) Gr.Mitgliederliste.Remove(ArchivTn))
