    ...
    Public Class TrainerValidationRule
        ...
        Public Overrides Function Validate(value As Object, cultureInfo As CultureInfo) As ValidationResult
            ...
            If bindingGroup.Items.Count = 1 Then
                ...
                Dim ValueListe = Controller.AppController.CurrentClub.AlleTrainer.Where(Function(Tr) Tr.TrainerID = Trainer.TrainerID)
                Dim Trainerliste = Controller.AppController.CurrentClub.AlleTrainer.Except(ValueListe)
