...
Public Class NeueLeistungsstufeDialog
    ...
    Private Sub Button_Click(sender As Object, e As RoutedEventArgs)
        ...
        Dim x = Controller.AppController.AktuellerClub.AlleLeistungsstufen.ToList.OrderByDescending(Function(Ls) Ls.Sortierung).ToList.Select(Function(Ls) $"{Ls.Sortierung} {Ls.Benennung}{Environment.NewLine}")
